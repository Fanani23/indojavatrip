   ...
   <div className="contain">
    <div className="body">
     ...
     <div className="header">
      <h1>East Java 6 Days / 5 Nights</h1>
      <p>
       Explore the breathtaking wonders of East Java with our exclusive 6 days
       and 5 night packages. Immerse yourself in the rich cultural tapestry,
       ...
       breathtaking wonders of East Java with our meticulously crafted 6 days
       and 5 night packages. Delve deep into the heart of this mesmerizing
     ...
     <div className="main">
      ...
      <div className="menu">
       <Card className="item">
        <img className="img" src={images.dest17} alt="Menu 1" />
        <div className="star">
        ...
        <a href="/destination-17" rel="noopener noreferrer">
         Bromo, Ijen Crater, Tumpaksewu, Malang & Surabaya
        </a>
        <p>
