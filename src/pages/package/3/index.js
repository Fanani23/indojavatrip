   ...
   <div className="contain">
    <div className="body">
     ...
     <div className="header">
      <h1>East Java 4 Days / 3 Nights</h1>
      <p>
       Explore the breathtaking wonders of East Java with our exclusive 4 days
       and 3 night packages. Immerse yourself in the rich cultural tapestry,
       ...
       breathtaking wonders of East Java with our meticulously crafted 4 days
       and 3 night packages. Delve deep into the heart of this mesmerizing
     ...
     <div className="main">
      ...
      <div className="menu">
       <Card className="item">
        <img className="img" src={images.dest7} alt="Menu 1" />
        <div className="star">
        ...
        <a href="/destination-7" rel="noopener noreferrer">
       ...
       <Card className="item">
        <img className="img" src={images.dest8} alt="Menu 2" />
        <div className="star">
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
        ...
        />
        <h6>4 Days / 3 Nights</h6>
        <a href="/destination-8" rel="noopener noreferrer">
       ...
       <Card className="item">
        <img className="img" src={images.dest9} alt="Menu 3" />
        <div className="star">
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
        ...
        />
        <h6>4 Days / 3 Nights</h6>
        <a href="/destination-9" rel="noopener noreferrer">
       ...
       <Card className="item">
        <img className="img" src={images.dest10} alt="Menu 4" />
        <div className="star">
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
        ...
        <h6>4 Days / 3 Nights</h6>
        <a href="/destination-10" rel="noopener noreferrer">
         Bromo, Ijen Crater & Malang
        </a>
        <p>
         In this package you will get amazing views such as active volcanoes,
         beautiful waterfalls and the diversity of places you visit.
       ...
       <Card className="item">
        <img className="img" src={images.dest11} alt="Menu 5" />
        <div className="star">
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
        ...
        />
        <h6>4 Days / 3 Nights</h6>
        <a href="/destination-11" rel="noopener noreferrer">
       ...
       <Card className="item">
        <img className="img" src={images.dest12} alt="Menu 6" />
        <div className="star">
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
         <span className="full">&#9733;</span>
        ...
        />
        <h6>4 Days / 3 Nights</h6>
        <a href="/destination-12" rel="noopener noreferrer">
         Bromo, Tumpaksewu & Malang
        </a>
        <p>
         In this package you will get amazing views such as active volcanoes,
         beautiful waterfalls and the diversity of places you visit.
