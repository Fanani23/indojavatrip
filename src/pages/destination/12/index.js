 ...
 return (
  <div className="dest12">
   ...
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest12L} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>4 Day 3 Night Bromo, Ijen Crater & Malang</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>
                12.00 - 17.00 | Check out hotel and depart to Hotel in Malang
               </li>
               <li>17.30 - 18.30 | Check in hotel</li>
               <li>
                18.30 - 21.00 | Shopping in Malang city area, dinner, Town
                square Batu city
               </li>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>21.30 - 21.30 | Finish</li>
              </ul>
             </CardText>
             <h6 style={{ color: 'red' }}>
              Note: Return flight at night or stay one night in Suarabaya, we
              can change the itinerary to suit your flight schedule. You will
              get detailed the itinerary once you submit your flight time
              schedule
             </h6>
            </Card>
           </Col>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest12} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
