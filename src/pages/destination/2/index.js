 ...
 return (
  <div className="dest2">
   ...
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest2} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>Mount Bromo</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>12.00 - 16.30 WIB | Depart to Surabaya City</li>
              </ul>
             </CardText>
             <h6 style={{ color: 'red' }}>
              Note: We can change the itinerary schedule to suit your flight.
              You will get detailed itinerary once you submit your flight time
              schedule.
             </h6>
            </Card>
           </Col>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest2} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
