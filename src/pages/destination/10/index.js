...
const Destination10 = () => {
 ...
 return (
  <div className="dest10">
   <Navbar />
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest10L} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>4 Day 3 Night Bromo, Tumpaksewu & Surabaya</h1>
      <p>
          ...
          <Row>
           <Col sm="12">
            <Card body>
             ...
             <CardText>
              <ul>
               <li>06.00 - 06.00 WIB | Panorama Kapas Biru</li>
               <li>06.30 - 07.00 WIB | Breakfast</li>
               <li>
                07.00 - 09.00 WIB | Panorama Tumpaksewu (Walk 200 meters), Wall
                Nirwana, Blue Lake, Drip Cave
               </li>
               <li>
                09.00 - 09.00 WIB | Return to cottages (Climb in approx 30
                minutes)
               </li>
               <li>09.00 - 12.00 WIB | Lunch and checkout</li>
               <li>12.30 - 16.00 WIB | Depart to Hotel Malang city</li>
               <li>16.30 - 18.00 WIB | Check in hotel, dinner, and rest</li>
              </ul>
             </CardText>
            </Card>
           </Col>
          ...
          <Row>
           <Col sm="12">
            <Card body>
             ...
             <h6 style={{ color: 'red' }}>
              Note: Return flight at night or stay one night in Surabaya, we can
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest10} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
