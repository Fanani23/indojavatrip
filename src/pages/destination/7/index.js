 ...
 return (
  <div className="dest7">
   ...
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest7L} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>4 Day 3 Night Bromo, Ijen Crater & Tumpaksewu</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>12.00 - 16.30 WIB | Depart to Hotel Bondowoso city</li>
           ...
           <Col sm="12">
            <Card body>
             ...
             <CardText>
              <ul>
               <li>
                00.00 - 02.00 WIB | Depart to Ijen Paltuding Post (With take
                away breakfast)
               </li>
               <li>
                02.00 - 03.30 WIB | Start trekking to Ijen Peak (Climb in approx
                1 hour 30 minutes)
               </li>
               <li>
               ...
               <li>
                04.30 - 06.45 WIB | Relax and enjoy at Ijen Peak (Climb in
                approx 30 minutes)
               </li>
               <li>07.00 - 07.45 WIB | Return to parking area</li>
               <li>08.00 - 10.00 WIB | Return to the hotel</li>
               <li>
                12.00 - 17.00 WIB | Checkout hotel, depart to cottages
                Tumpaksewu area, and lunch
               </li>
               <li>17.30 - 20.00 WIB | Check in cottages, dinner, and rest</li>
              </ul>
             </CardText>
            </Card>
           </Col>
             ...
             <CardText>
              <ul>
               ...
               <li>
                ...
                Bottom Waterfall (Walk down 20 minutes), Wall Nirwana, Blue
                Lake, Drip Cave
               </li>
               <li>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest7} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
