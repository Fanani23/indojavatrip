...
const Destination16 = () => {
 ...
 return (
  <div className="dest16">
   <Navbar />
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest16L} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>5 Day 4 Night Bromo, Ijen Crater, Malang & Surabaya</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>10.00 - 12.00 | Check out Hotel</li>
               <li>
                12.30 - 16.00 | Depart to Hotel in Malang city area, lunch
               </li>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest16} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
