 ...
 return (
  <div className="dest5">
   ...
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest5} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>3 Day 2 Night Mount Bromo & Malang Batu City</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>12.00 - 16.30 WIB | Depart to Hotel Malang city</li>
               <li>16.30 - 16.30 WIB | Check in Hotel</li>
               <li>
                18.00 - 21.00 WIB | Shopping in Malang City area, dinner, and go
                to Town Square Batu City
               </li>
               <li>21.00 - 21.00 WIB | Return to the hotel and rest</li>
              </ul>
             </CardText>
            </Card>
           </Col>
          ...
          <Row>
           <Col sm="12">
            <Card body>
             ...
             <CardText>
              <ul>
               <li>07.00 - 08.00 WIB | Breakfast and checkout hotel</li>
               <li>09.00 - 10.00 WIB | Apple Garden</li>
               <li>
                10.30 - 12.00 WIB | Coban Rondo Waterfall and Maze Rondo
                Waterfall
               </li>
               <li>
                12.00 - 15.00 WIB | Paragliding Hill, Wooden Hill House, Sky
                Park, and lunch
               </li>
               <li>15.30 - 17.30 WIB | Transportation Museum</li>
               <li>18.00 - 19.30 WIB | Dinner in Batu City</li>
               <li>19.30 - 21.30 WIB | Depart to Surabaya city</li>
              </ul>
             </CardText>
             <h6 style={{ color: 'red' }}>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>Entrance Ticket in Malang / Batu City</li>
               <li>Wifi portable</li>
              </ul>
             </CardText>
            </Card>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest5} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
