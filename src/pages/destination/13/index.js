...
const Destination13 = () => {
 ...
 return (
  <div className="dest13">
   <Navbar />
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest13L} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>5 Day 4 Night Bromo, Ijen Crater, Tumpaksewu & Surabaya</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>
                12.00 - 17.00 | Check out hotel and depart to cottages
                Tumpaksewu area, lunch
               </li>
               <li>17.30 - 20.00 | Check in hotel, dinner, and rest</li>
              </ul>
             </CardText>
            </Card>
           </Col>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>12.30 - 17.30 | Depart to Hotel in Surabaya city</li>
               <li>18.00 - 20.00 | Check in Hotel, dinner, and rest</li>
              </ul>
             </CardText>
            </Card>
           </Col>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest13} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
