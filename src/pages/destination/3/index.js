 ...
 return (
  <div className="dest3">
   ...
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest3} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>3 Day 2 Night Mount Bromo & Ijen Crater</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>
                09.00 - 11.30 WIB | Return to the hotel, breakfast & check out
                from hotel
               </li>
               <li>12.00 - 16.30 WIB | Depart to Bondowoso City</li>
               <li>16.30 - 16.30 WIB | Check in hotel, dinner, and rest</li>
              </ul>
             </CardText>
            </Card>
           </Col>
           ...
           <Col sm="12">
            <Card body>
             ...
             <CardText>
              <ul>
               <li>
                00.00 - 02.00 WIB | Depart to Ijen Paltituding Post (With
                takeaway breakfast)
               </li>
               <li>
                02.00 - 03.30 WIB | Start trekking to Ijen Peak (The climb has
                apporximately 1 hours and 30 minutes)
               </li>
               <li>
                04.00 - 04.30 WIB | Blue fire Ijen Crater (30 minutes Blue flame
                tracking)
               </li>
               <li>
                04.30 - 06.45 WIB | Relax and enjoy in Ijen Peak (The climb has
                approximately 30 minutes)
               </li>
               <li>07.00 - 07.45 WIB | Return to parking area</li>
               <li>08.00 - 10.00 WIB | Return to hotel</li>
               <li>
                12.00 - 17.00 WIB | Checkout hotel and depart to Surabaya city,
                launch
               </li>
               <li>18.30 - 18.30 WIB | Finish Surabaya city</li>
              </ul>
             </CardText>
             <h6 style={{ color: 'red' }}>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest3} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
