 ...
 return (
  <div className="dest6">
   ...
   <div className="cont">
    <div className="bod">
     <div className="cov">
      <img src={images.dest6} alt="Dest 1" />
     </div>
     <div className="hea">
      <h1>3 Day 2 Night Mount Bromo & Surabaya City</h1>
      <p>
            ...
            <Card body>
             ...
             <CardText>
              <ul>
               ...
               <li>12.00 - 16.30 WIB | Depart to Hotel Surabaya city</li>
               <li>16.30 - 16.30 WIB | Check in Hotel</li>
               <li>
                18.00 - 21.00 WIB | Sightseeing in the city of Surabaya and
                dinner
               </li>
     ...
     <div className="swiper">
      ...
      >
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 1" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 2" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 3" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 4" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 5" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 6" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 7" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 8" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 9" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 10" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 11" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 12" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 13" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 14" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 15" />
       </SwiperSlide>
       <SwiperSlide className="item">
        <img src={images.dest6} alt="Item 16" />
       </SwiperSlide>
      </Swiper>
     </div>
    </div>
